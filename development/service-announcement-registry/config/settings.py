...
if not ALLOWED_HOSTS:
    ALLOWED_HOSTS = ["localhost", "127.0.0.1", "announcement-registry-api"]
...
if os.environ.get("POSTGRES_DB"):
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ.get("POSTGRES_DB", "announcement_registry"),
            "USER": os.environ.get("POSTGRES_USER", "announcement_registry"),
            "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "announcement_registry"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "announcements.authentication.JWTAuthentication",
    ),
...
if HAS_DRF_SPECTACULAR:
    SPECTACULAR_SETTINGS = {
        "TITLE": "CLEVER Announcement Registry API",
        "DESCRIPTION": "Service-owned OpenAPI schema for service-announcement-registry.",
        "VERSION": "1.0.0",
