...
if os.environ.get("POSTGRES_DB"):
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ.get("POSTGRES_DB", "driver_vehicle_assignment"),
            "USER": os.environ.get("POSTGRES_USER", "driver_vehicle_assignment"),
            "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "driver_vehicle_assignment"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "assignments.authentication.JWTAuthentication",
    ),
    "DEFAULT_PERMISSION_CLASSES": (
        "rest_framework.permissions.IsAuthenticated",
    ),
    "EXCEPTION_HANDLER": "assignments.exceptions.api_exception_handler",
}
if HAS_DRF_SPECTACULAR:
...
if HAS_DRF_SPECTACULAR:
    SPECTACULAR_SETTINGS = {
        "TITLE": "CLEVER Driver Vehicle Assignment API",
        "DESCRIPTION": "Service-owned OpenAPI schema for service-vehicle-assignment.",
        "VERSION": "1.0.0",
