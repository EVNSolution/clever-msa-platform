...
INSTALLED_APPS = [
    ...
    "corsheaders",
    "rest_framework",
    "dispatchops.apps.DispatchOpsConfig",
]
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "dispatchops.authentication.JWTAuthentication",
    ),
    "DEFAULT_PERMISSION_CLASSES": (
        "dispatchops.permissions.AuthenticatedReadOnly",
    ),
    "EXCEPTION_HANDLER": "dispatchops.exceptions.api_exception_handler",
}
if HAS_DRF_SPECTACULAR:
...
if HAS_DRF_SPECTACULAR:
    SPECTACULAR_SETTINGS = {
        "TITLE": "CLEVER Dispatch Operations View API",
        "DESCRIPTION": "Service-owned OpenAPI schema for service-dispatch-operations-view.",
        "VERSION": "1.0.0",
...
DRIVER_VEHICLE_ASSIGNMENT_BASE_URL = os.environ.get(
    ...
    "http://driver-vehicle-assignment-api:8000",
)
VEHICLE_ASSET_BASE_URL = os.environ.get(
