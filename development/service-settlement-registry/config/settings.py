...
if os.environ.get("POSTGRES_DB"):
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ.get("POSTGRES_DB", "settlement_registry"),
            "USER": os.environ.get("POSTGRES_USER", "settlement_registry"),
            "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "settlement_registry"),
