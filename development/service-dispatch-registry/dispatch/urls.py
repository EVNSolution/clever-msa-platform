...
from dispatch.views import (
    ...
    DispatchUploadBatchListView,
    DispatchUploadConfirmView,
    DispatchUploadPreviewView,
...
urlpatterns = [
    ...
    path("upload-batches/", DispatchUploadBatchListView.as_view()),
    path("upload-batches/preview/", DispatchUploadPreviewView.as_view()),
    path("upload-batches/<uuid:upload_batch_id>/confirm/", DispatchUploadConfirmView.as_view()),
