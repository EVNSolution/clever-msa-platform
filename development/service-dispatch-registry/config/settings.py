...
if os.environ.get("POSTGRES_DB"):
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ.get("POSTGRES_DB", "dispatch_registry"),
            "USER": os.environ.get("POSTGRES_USER", "dispatch_registry"),
            "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "dispatch_registry"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "dispatch.authentication.JWTAuthentication",
    ),
    "DEFAULT_PERMISSION_CLASSES": (
        "rest_framework.permissions.IsAuthenticated",
    ),
    "EXCEPTION_HANDLER": "dispatch.exceptions.api_exception_handler",
}
if HAS_DRF_SPECTACULAR:
...
if HAS_DRF_SPECTACULAR:
    SPECTACULAR_SETTINGS = {
        "TITLE": "CLEVER Dispatch Registry API",
        "DESCRIPTION": "Service-owned OpenAPI schema for service-dispatch-registry.",
        "VERSION": "1.0.0",
