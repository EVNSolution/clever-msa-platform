...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "driver360.authentication.JWTAuthentication",
    ),
    "DEFAULT_PERMISSION_CLASSES": (
        "rest_framework.permissions.IsAuthenticated",
    ),
    "EXCEPTION_HANDLER": "driver360.exceptions.api_exception_handler",
}
if HAS_DRF_SPECTACULAR:
...
if HAS_DRF_SPECTACULAR:
    SPECTACULAR_SETTINGS = {
        "TITLE": "CLEVER Driver Operations View API",
        "DESCRIPTION": "Service-owned OpenAPI schema for service-driver-operations-view.",
        "VERSION": "1.0.0",
...
ACCOUNT_AUTH_BASE_URL = os.environ.get("ACCOUNT_AUTH_BASE_URL", "http://account-auth-api:8000")
