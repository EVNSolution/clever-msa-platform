...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "organization_master"),
        "USER": os.environ.get("POSTGRES_USER", "organization_master"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "organization_master"),
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "organizations.exceptions.api_exception_handler",
}
if HAS_DRF_SPECTACULAR:
...
if HAS_DRF_SPECTACULAR:
    SPECTACULAR_SETTINGS = {
        "TITLE": "CLEVER Organization Registry API",
        "DESCRIPTION": "Service-owned OpenAPI schema for service-organization-registry.",
        "VERSION": "1.0.0",
