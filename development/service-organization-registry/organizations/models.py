...
class Company(models.Model):
    ...
    tenant_code = models.SlugField(max_length=100, unique=True, null=True, blank=True)
    workflow_profile = models.CharField(max_length=100, blank=True, default="")
    enabled_features = models.JSONField(default=list, blank=True)
    home_dashboard_preset = models.JSONField(default=dict, blank=True)
    workspace_presets = models.JSONField(default=dict, blank=True)
