...
class VehicleSummaryServiceTests(TestCase):
    ...
    def test_build_summary_fails_when_terminal_registry_service_is_unavailable(self):
        service = VehicleSummaryService(
            source_clients=FakeSourceClients(
                vehicle=self.vehicle,
                companies=self.companies,
    ...
    def test_build_summary_fails_when_telemetry_service_is_unavailable(self):
        service = VehicleSummaryService(
            source_clients=FakeSourceClients(
                vehicle=self.vehicle,
                companies=self.companies,
