...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "vehicleops.authentication.JWTAuthentication",
    ),
    "DEFAULT_PERMISSION_CLASSES": (
        "vehicleops.permissions.AuthenticatedReadOnly",
    ),
...
TELEMETRY_HUB_BASE_URL = os.environ.get(
    "TELEMETRY_HUB_BASE_URL",
    "http://telemetry-hub-api:8000",
)
TERMINAL_REGISTRY_BASE_URL = os.environ.get(
