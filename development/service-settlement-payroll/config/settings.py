...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "settlement_payroll"),
        "USER": os.environ.get("POSTGRES_USER", "settlement_payroll"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "settlement_payroll"),
...
if HAS_DRF_SPECTACULAR:
    SPECTACULAR_SETTINGS = {
        "TITLE": "CLEVER Settlement Payroll API",
        "DESCRIPTION": "Service-owned OpenAPI schema for service-settlement-payroll.",
        "VERSION": "1.0.0",
...
SETTLEMENT_REGISTRY_BASE_URL = os.environ.get(
    "SETTLEMENT_REGISTRY_BASE_URL",
    "http://settlement-registry-api:8000",
)
DELIVERY_RECORD_BASE_URL = os.environ.get(
    "DELIVERY_RECORD_BASE_URL",
    "http://delivery-record-api:8000",
)
DISPATCH_REGISTRY_BASE_URL = os.environ.get(
    "DISPATCH_REGISTRY_BASE_URL",
    "http://dispatch-registry-api:8000",
)
ATTENDANCE_REGISTRY_BASE_URL = os.environ.get(
    "ATTENDANCE_REGISTRY_BASE_URL",
    "http://attendance-registry-api:8000",
)
