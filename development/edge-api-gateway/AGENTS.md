...
- The single surviving web runtime lives in `../front-web-console/`.
- `../front-operator-console/` is legacy historical context, not an active edge target.
- Local integration compose lives in the out-of-band integration repo, not in the root `development/` whitelist.
