...
| `front-driver-app` | front | driver-only mobile app child repo | Android/iOS 배송원 native self-service 앱. framework는 별도 결정 전까지 `TBD` | `development/front-driver-app/` | `empty-shell` |
