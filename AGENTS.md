...
- `service-settlement-registry` and `service-delivery-record` are shell repos and should not silently receive runtime logic without an approved boundary update.
