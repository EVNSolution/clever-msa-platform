...
1. [ev-dashboard-preprod-release-gate.md](ev-dashboard-preprod-release-gate.md) 로 temporary lane candidate proof를 수행한다.
...
6. deploy 중에는 [ev-dashboard-ecs-deploy-operator-loop.md](ev-dashboard-ecs-deploy-operator-loop.md)의 phase table과 decision table만 본다. 조급한 재시도는 하지 않는다.
...
- [ev-dashboard-preprod-release-gate.md](ev-dashboard-preprod-release-gate.md)
...
- [ev-dashboard-ecs-deploy-operator-loop.md](ev-dashboard-ecs-deploy-operator-loop.md)
