...
4. mobile appendix도 같은 font 축을 우선 검토하되, 실제 native app font loading/linking 방식은 framework 결정 후 확정한다.
...
4. exact component composition과 design token export 방식은 선택된 native framework 기준으로 후속 확정한다.
